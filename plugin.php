...
if (!function_exists('add_shortcode')) return "No direct call for Percentage Calculator by Calculator.iO";

function display_ci_percentage_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_percentage_calculator', 'display_ci_percentage_calculator' );